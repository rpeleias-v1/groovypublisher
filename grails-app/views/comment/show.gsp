            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.who.label" default="Who" /></td>
                            
                            <td valign="top" class="value"><g:link controller="commentator" action="show" id="${commentInstance?.who?.id}">${commentInstance?.who?.encodeAsHTML()}</g:link></td>

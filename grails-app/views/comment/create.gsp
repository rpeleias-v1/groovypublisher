                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: commentInstance, field: 'post', 'errors')}">
                                    <g:select name="post.id" from="${groovypublish.Post.list()}" optionKey="id" value="${commentInstance?.post?.id}"  />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="who"><g:message code="comment.who.label" default="Who" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: commentInstance, field: 'who', 'errors')}">
                                    <g:select name="who.id" from="${groovypublish.Commentator.list()}" optionKey="id" value="${commentInstance?.who?.id}"  />
                                </td>
                            </tr>
